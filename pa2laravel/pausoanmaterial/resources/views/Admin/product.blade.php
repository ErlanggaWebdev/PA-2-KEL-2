      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="logo-area">
              <a href="#"><img src="img/logo/lala.png" width="150px" height="48px" alt="" /></a>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
              <li class="">
                <a data-toggle="tab" href="index.html"><i class="notika-icon notika-house"></i> Home</a>
              </li>
              <li class="active">
                <a href="product.html"><i class="notika-icon notika-mail"></i> Product</a>
              </li>
              <li>
